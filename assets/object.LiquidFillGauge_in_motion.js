...
function SVGLiquidFillGaugeDrawer(input){
    var default_style={
        ...
        waveRiseTime:       ['int', 1000], // The amount of time in milliseconds for the wave to rise from 0 to it's final height.
        waveAnimateTime:    ['int', 18000], // The amount of time in milliseconds for a full wave to enter the wave circle.
        waveRise:           ['bool', true], // Control if the wave should rise from 0 to it's full height, or start at it's full height.
        ...
        waveAnimate:        ['bool', true], // Controls if the wave scrolls or is static.
    ...
    */
    ...
    for (var date in dataset.charts[0].data){
        ...
        for(var chart in dataset.charts){
            ...
            _add_graph(('location_' + I),dataset.charts[chart].data[date].real,input.style)
            I++
